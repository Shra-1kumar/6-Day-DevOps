...
```bash
sudo chown -R jenkins:jenkins /shravan/lib/jenkins/workspace/Retail-app
sudo chmod -R 777 /shravan/lib/jenkins/workspace/Retail-app
sudo rm -rf /shravan/lib/jenkins/workspace/Retail-app/data
```
